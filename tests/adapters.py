...
def run_multihead_self_attention_with_rope(
    ...
    Returns:
        ...
        implementation with the given QKV projection weights and input features.
    """
    layer = MultiHeadSelfAttention(d_model, num_heads, max_seq_len, theta, use_rope=True)
    layer.load_state_dict({
        "q_proj.weight": q_proj_weight,
        "k_proj.weight": k_proj_weight,
        "v_proj.weight": v_proj_weight,
    ...
    return layer.forward(in_features, token_positions)
...
def run_transformer_block(
    ...
    return block.forward(in_features, torch.arange(in_features.shape[-2], device=in_features.device))
...
def run_silu(in_features: Float[Tensor, " ..."]) -> Float[Tensor, " ..."]:
    ...
    """
    return in_features * in_features.sigmoid()
